...
public class TransformingMapTest {
    ...
    private static final Map.Entry<String, String> T_ENTRY_1 = new TestEntry<String, String>(T_KEY_1, T_VALUE_1);
    private static final Map.Entry<String, String> T_ENTRY_2 = new TestEntry<String, String>(T_KEY_2, T_VALUE_2);
